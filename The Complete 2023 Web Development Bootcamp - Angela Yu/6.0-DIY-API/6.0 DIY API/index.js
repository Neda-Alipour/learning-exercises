...
app.put("/jokes/:id", (req, res)=>{
  ...
  const foundIndex = jokes.findIndex((joke) => joke.id === jokeId)
  jokes[foundIndex] = joke
  res.json(joke)
})
...
app.patch("/jokes/:id", (req, res)=>{
  ...
  jokes[jokeId] = replacementJoke
  res.json(jokes[jokeId])
})

//7. DELETE Specific joke
// There is another way in solution.js
...
app.get("/jokes/all", (req, res)=>{
  ...
  if (apiKey === masterKey){
    ...
    res
      .status(404)
      .json({ error: "You're not allowed to delete all jokes."})
  }
})
